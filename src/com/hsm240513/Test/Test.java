...
import com.hsm240513.Management.ManagementImp;
    ...
    static int returnMsg(int msg) {
        ...
        switch (msg) {
            ...
            case 3:
                ...
                result = manager.removeBook(Integer.parseInt(id));
                System.out.println(result.getMsg());
                break;
            case 4:
                result = new Result();
                ...
                result = manager.updateBooks(Integer.parseInt(id1));
                System.out.println(result.getMsg());
                break;
            case 5:
                result = new Result();
                ...
                result = manager.borrowBook(Integer.parseInt(id2));
                System.out.println(result.getMsg());
                break;
            case 6:
                result = new Result();
